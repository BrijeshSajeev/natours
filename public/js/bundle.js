...
var displayMap = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          bounds = L.latLngBounds(points).pad(0.5);
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51NuECTSEwqRC9OPWI6jDq6bODtxRNf4vNH4vTkArbjkLG60Utj5vqZVyrbQaDR2AlTjP5QBI5unmLUIJDme3Ssux00iG2U9VSI');
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var updateFrom = document.querySelector('.form-user-data');
var updatePasswordFrom = document.querySelector('.form-user-password');
...
if (btnBookTour) {
  btnBookTour.addEventListener('click', /*#__PURE__*/function () {
